...
![jenga-boy](/static/images/jenga-boy.jpg)
<UnsplashLicense photoURL="https://unsplash.com/photos/geNNFqfvw48" author="Michał Parzuchowski" />
...
console.log(names) // => ["Andy", "Paul", "Jesse", "Ken"]
```
